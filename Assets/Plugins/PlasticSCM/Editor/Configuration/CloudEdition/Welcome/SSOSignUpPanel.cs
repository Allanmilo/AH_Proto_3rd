        ...
        SignUp.INotify
    {
        ...
        void BuildComponents()
        {
            ...
            if (EditorGUIUtility.isProSkin)
                dashes.ForEach(x => x.style.borderTopColor = new StyleColor(new Color(0.769f, 0.769f, 0.769f)));
            else
                dashes.ForEach(x => x.style.borderTopColor = new StyleColor(new Color(0.008f, 0.008f, 0.008f)));
            ...
            this.SetControlImage("googleIcon", Images.Name.ButtonSsoSignInGoogle);
            ...
            if (hideGoogleSignUpButton)
            {
                //TODO: remove this once Google sign up functionality is added
                googleButton.style.display = DisplayStyle.None;
                mSignUpWithUnityButton.style.width = new StyleLength(new Length(99f, LengthUnit.Percent));
            }

        ...
        PendingChangesOptionsDialog.IAutorefreshView
    {
        ...
        internal void OnGUI()
        {
            DrawCommentTextArea.For(
                this, mParentWindow.position.width,
            ...
            bool isCommentWarningNeeded)
        {
            ...
            {
                using (new GuiEnabled(!isCommentWarningNeeded))
                {
